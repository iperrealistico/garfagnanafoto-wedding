...
import { LeadPayload, LeadPayloadSchema } from "../../lib/config-schema";
...
export function LeadForm({ onSubmitSuccess, gdprNotice, lang, initialPayload, submitLabel }: LeadFormProps) {
